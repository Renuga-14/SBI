                    ...
                    foreach ($responseInput as $key => $value) {
                        ...
                        if ($key === "reviewProposalResponse") {
                            ...
                            switch (strtolower($language)) {
                                ...
                                case 'kan':
                                    $questionText = "1.ವೈದ್ಯಕೀಯ ಪ್ರಶ್ನಾವಳಿಗಾಗಿ ಪ್ರಪೋಸಲ್ ಫಾರ್ಮ್ನಲ್ಲಿ ನೀವು ಕೊಟ್ಟಿರುವ ಉತ್ತರಗಳನ್ನು ಪುನಃ ಪರಿಶೀಲಿಸಲು ಇಷ್ಟಪಡುತ್ತೀರಾ?";
                                    break;
        
                                case 'tel':
                                    $questionText = "1.వైద్యకీయ ప్రశ్నావళి కోసం ప్రతిపాదన ఫారంలో అందించిన స్పందనలను పరిశీలించాలని అనుకుంటున్నారా?";
                                    break;
        
                                case 'mal':
                                    $questionText = "1.മെഡിക്കൽ ചോദ്യാവലിയുടെ കാര്യത്തിൽ പ്രൊപ്പോസൽ ഫോമിൽ നിങ്ങൾ നൽകിയിരിക്കുന്ന പ്രതികരണങ്ങൾ പുനരവലോകനം ചെയ്യാൻ നിങ്ങൾ ആഗ്രഹിക്കുന്നുണ്ടോ?";
                                    break;
                                ...
                                case 'mar':
                                    $questionText = "1.तुम्हाला मेडिकल प्रश्नावलीसाठीच्या प्रपोझल फॉर्म मध्ये तुम्ही दिलेल्या प्रतिसादांचे तुम्हाला पुनरावलोकन करावयाचे आहे का?";
                                    break;
        
                                case 'guj':
                                    $questionText = "1.તબીબી પ્રશ્નાવલી માટેના પ્રસ્તાવ પત્રકમાં તમે આપેલા જવાબોની તમે સમીક્ષા કરવા ચાહો છો?";
                                    break;
        
        
                                case 'ori':
                                    $questionText = "1.ଆପଣ ଡାକ୍ତରୀ ପ୍ରଶ୍ନାବଳି ପାଇଁ ପ୍ରସ୍ତାବ ଫର୍ମରେ ଦିଆଯାଇଥିବା ଆପଣଙ୍କର ଉତ୍ତର ସମୀକ୍ଷା କରିବାକୁ ଚାହାନ୍ତି କି?";
                                    break;
        
        
                                case 'pun':
                                    $questionText = "1.ਕੀ ਤੁਸੀਂ ਮੇਡਿਕਲ ਪ੍ਰਸ਼ਨਾਵਲੀ ਲਈ ਪ੍ਰਸਤਾਵ ਫਾਰਮ ਵਿੱਚ ਦਿੱਤੀ ਗਈ ਪ੍ਰਕ੍ਰਿਆਵਾਂ ਦੀ ਸਮਿੱਖਿਆ ਕਰਵਾਉਣਾ ਚਾਹੁੰਦੇ ਹੋ ?";
                                    break;
        
                                case 'ben':
                                    $questionText = "1.আপনি কী মেডিক্যাল প্রশ্নোত্তরের জন্যে প্রস্তাব ফর্মে দেওয় আপনার প্রতিক্রিয়া, পুনর্সমীক্ষা করতে ইচ্ছুক?";
                                    break;
        
        
                                case 'ass':
                                    $questionText = "1.চিকিৎসা বিষয়ক প্ৰশ্নাৱলীৰ হেতু প্ৰস্তাৱ প্ৰপত্ৰত দিয়া আপোনাৰ উত্তৰ সমূহৰ আপুনি পুনৰুক্ষণ কৰিব বিচাৰেনেকি?";
                                    break;
        
                                case 'miz':
                                    $questionText = "1.Damdawi lampang zawhna Proposal form ami I chhanna hi ennawn leh I duh em?";
                                    break;
                                ...
                                default:
                                    $questionText = "1.मैडिकल क्‍वेश्‍चनायर वासतै प्रस्‍ताव प्रपत्र मैं आप जिका जवाब दिया हा थे बांनैं फेर स्‍यूं देखनो चाहोगा के?";
                                    break;
                            }
