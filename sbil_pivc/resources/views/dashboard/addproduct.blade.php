    ...
    <li class="p-3 hover:bg-gray-200 rounded-lg cursor-pointer flex items-center">
        ...
        <main class="flex-1 flex flex-col p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 id="page-title" class="text-3xl font-bold">Products</h2>
      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            <label for="uin_no" class="block text-sm/6 font-medium text-gray-900">Uin no</label>
            <div class="mt-2">
              <input type="text" name="uin_no" id="uin_no" autocomplete="off" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            </div>
          </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <input type="text" name="product_name" id="product_name" autocomplete="off" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            </div>
          </div>


          <div class="sm:col-span-3">
            <label for="source_id" class="block text-sm/6 font-medium text-gray-900">Source id</label>
            <div class="mt-2">
              <input type="text" name="source_id" id="source_id" autocomplete="off" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            </div>
          </div>


          <div class="sm:col-span-3">
            <label for="product_slug" class="block text-sm/6 font-medium text-gray-900">product_slug</label>
            <div class="mt-2">
              <input type="text" name="product_slug" id="product_slug" autocomplete="off" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            </div>
          </div>
...
<br>
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        <a href="{{ route('addproduct') }}" class="px-4 py-2 bg-white-500 text-black text-sm font-medium rounded-lg shadow hover:bg-orange-300">cancel</a>
