...
<div class="pb-4 flex justify-end pr-2 rounded shadow bg-white-900 p-4">
    ...
    <a href="{{ route('products.export') }}" class="px-4 py-2 bg-orange-500 text-white text-sm font-medium rounded-lg shadow hover:bg-orange-300">
        Excel Download
    </a>
</div>
    ...
    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
        ...
        <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            ...
            <thead>
                ...
                <tr>
                    <th data-priority="1">uin_no</th>
                    <th data-priority="2">product_name</th>
                    <th data-priority="3">source_id</th>
                    <th data-priority="4">product_slug</th>
                    <th data-priority="5">status</th>
                    <th data-priority="6">created_on</th>
                    <th data-priority="6">updated_on</th>
                </tr>
            </thead>
            <tbody>
