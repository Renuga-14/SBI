    ...
    <li class="p-3 hover:bg-gray-200 rounded-lg cursor-pointer flex items-center">
        ...
        <main class="flex-1 flex flex-col p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 id="page-title" class="text-3xl font-bold">Links</h2>
        ...
        <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            <thead>
                <tr>
                    ...
                    <th data-priority="1">proposal_no</th>


                    <th data-priority="5">link_short</th>
                    <th data-priority="6">complete_status</th>
                    <th data-priority="7">disagree_status</th>
                    <th data-priority="8">sftp_status</th>
                    <th data-priority="9">completed_on</th>
                    <th data-priority="10">created_on</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td >{{ $links->proposal_no}}</td>
                    <td>{{ $links->link_short }}</td>
                    <td>{{ $links->complete_status }}</td>
                    <td>{{ $links->disagree_status }}</td>
                    <td>{{ $links->sftp_status }}</td>
                    <td>{{ $links->completed_on }}</td>
                    <td>{{ $links->created_on }}</td>
